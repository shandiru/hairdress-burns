        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div data-aos="fade-right">
            ...
            <div className="space-y-6 mb-8">
              ...
              <a href="tel:01159374180" className="flex items-start space-x-4 hover:text-teal-300">
            ...
            <div className="bg-teal-600 text-white p-6 rounded-xl shadow-lg" data-aos="zoom-in">
            ...
            <form className="space-y-6" onSubmit={sendEmail}>
              ...
              <div>
                ...
                >
                  ...
                  <option value="blowdry-finish" className="text-stone-800">Blowdry & Finish</option>
                  <option value="root-tint" className="text-stone-800">Root Tint</option>
                  <option value="half-mech" className="text-stone-800">Half Mech</option>
                  <option value="full-mech" className="text-stone-800">Full Mech</option>
                  <option value="demi-semi" className="text-stone-800">Demi/Semi</option>
                  <option value="consultation" className="text-stone-800">Free Consultation</option>
                </select>
              </div>
